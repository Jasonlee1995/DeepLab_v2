...
class MSC_ResNet101_ASPP():
    def __init__(self, num_classes, atrous_rates, scales, ignore_index=-1, gpu_id=0, print_freq=10, epoch_print=10):
        ...
        self.model = model.ResNet101_ASPP(self.num_classes, self.atrous_rates, self.scales).cuda(self.gpu)
